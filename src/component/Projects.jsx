				...
				*{/* project 2 */}
				<div className="relative grid gap-4 p-2 mb-16 bg-gray-100 shadow-md md:grid-cols-2 md:mb-20 lg:mb-10 lg:gap-0 md:gap-1 bg-opacity-30 md:bg-transparent md:p-0 md:shadow-none">
					...
					<div className="z-20 order-1 col-span-1 text-left">
						...
						<p className="mb-3 text-xl font-semibold text-white">SocialLink</p>
						<p className="text-sm bg-white shadow-md rounded-sm py-4 pr-2 pl-3 text-gray-600 lg:max-w-[490px] lg:absolute lg:left-0 mt-3 z-30">
							...
							<span className="text-orange-400">group project</span>. In the website a user can
							follow other users. He can also like, comment, share stories with their followers.
						</p>
						...
						<div className="flex items-center justify-start gap-6 mt-3 text-2xl text-white">
							<a
								href="https://github.com/mk-saadi/social-link"
								target="_blank"
								rel="noopener noreferrer"
				...
				<div className="relative grid gap-4 p-2 mb-16 bg-gray-100 rounded-md shadow-md md:grid-cols-2 md:mb-20 lg:mb-10 lg:gap-0 md:gap-1 bg-opacity-30 md:shadow-none md:p-0 md:bg-transparent">
					...
					<div className="z-20 col-span-1 text-right">
						...
						<p className="mb-3 text-xl font-semibold text-white">animeFig</p>
						<p className="text-sm bg-white shadow-md rounded-sm py-4 pr-2 pl-3 text-gray-600 lg:max-w-[490px] lg:absolute lg:right-0 mt-3 z-30">
							animeFig Is a <span className="text-orange-400">full-stack</span> web application.
							Anyone logged in can view details of the figures or add new figures. Edit and
							delete is also implemented in the website. For styling Tailwind CSS and daisyUI
							were used.
						</p>
				...
				<div className="relative grid gap-4 p-2 mb-16 bg-gray-100 rounded-md shadow-md md:grid-cols-2 md:mb-20 lg:mb-10 lg:gap-0 md:gap-1 bg-opacity-30 md:shadow-none md:p-0 md:bg-transparent">
					...
					<div className="z-20 order-1 col-span-1 text-left">
						...
						<p className="mb-3 text-xl font-semibold text-white">SoundWaves</p>
						<p className="text-sm bg-white shadow-md rounded-sm py-4 pr-2 pl-3 text-gray-500 lg:max-w-[490px] lg:absolute lg:left-0 mt-3 z-30">
							...
							<span className="text-orange-400">dynamic user based dashboard</span>. Admin can
							promote or delete users at his will. Instructors can add or manage their classes.
							Students can choose classes and pay for that class using stripe.
						</p>
						...
						<div className="flex items-center justify-start gap-6 mt-3 text-2xl text-white">
							<a
								...
								className="flex items-center justify-center gap-2 duration-200 hover:text-orange-400"
							>
								<FaGithub /> <span className="text-sm">Client</span>
							</a>
							<a
								...
								className="flex items-center justify-center gap-2 duration-200 hover:text-orange-400"
							>
								<FaGithub /> <span className="text-sm">Server</span>
							</a>
							<a
								href="https://summercamp12-1ae5f.web.app/"
								target="_blank"
				...
				<div className="relative grid gap-4 p-2 mb-16 bg-gray-100 rounded-md shadow-md md:grid-cols-2 md:mb-20 lg:mb-10 lg:gap-0 md:gap-1 bg-opacity-30 md:shadow-none md:p-0 md:bg-transparent">
					...
					<div className="z-20 order-2 col-span-1 text-right">
						...
						<p className="mb-3 text-xl font-semibold text-white">Smoki'n</p>
						<p className="text-sm bg-white shadow-md rounded-sm py-4 pr-2 pl-3 text-gray-600 lg:max-w-[490px] lg:absolute lg:right-0 mt-3 z-30">
							Smoki'n is a Single page React project. It's main feature is it's firebase
							integration, dynamic url.
						</p>
				...
				<div className="relative grid gap-4 p-2 mb-16 bg-gray-100 rounded-md shadow-md md:grid-cols-2 md:mb-20 lg:mb-10 lg:gap-0 md:gap-1 bg-opacity-30 md:shadow-none md:p-0 md:bg-transparent">
					...
					<div className="z-20 order-1 col-span-1 text-left">
						...
						<p className="mb-3 text-xl font-semibold text-white">Geometry Genius</p>
						<p className="text-sm bg-white shadow-md rounded-sm py-4 pr-2 pl-3 text-gray-500 lg:max-w-[490px] lg:absolute lg:left-0 mt-3 z-30">
							Geometry Genius is a <span className="text-orange-400">javascript</span>{" "}
							application. The website is made to do simple geometry calculation.
						</p>
				...
				<div className="relative grid gap-4 p-2 mb-16 bg-gray-100 rounded-md shadow-md md:grid-cols-2 md:mb-20 lg:mb-10 lg:gap-0 md:gap-1 bg-opacity-30 md:shadow-none md:p-0 md:bg-transparent">
					...
					<div className="z-20 order-2 col-span-1 text-right">
						...
						<p className="mb-3 text-xl font-semibold text-white">Prohub</p>
						<p className="text-sm bg-white shadow-md rounded-sm py-4 pr-2 pl-3 text-gray-600 lg:max-w-[490px] lg:absolute lg:right-0 mt-3 z-30">
